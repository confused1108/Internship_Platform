        ...
        <div class="col-sm-6">
            ...
            <div class="tab-content">
                ...
                <div id="menu1" class="tab-pane fade">
                    <form name="myForm" onsubmit="return validatePost()" method="post" action="eregisterpost.php" style="background-color:rgb(217, 217, 217);width:70%;margin-left: 15%;margin-top:6%;border: 1px solid grey;border-radius:5px;padding:5px">
                        ...
                        <div class="form-group" style="padding-left:10px;padding-right:10px;" >
                            ...
                            <input type="Name" name="comp_name" class="form-control" id="Name" placeholder=" Company Name" required>

                        </div>
                        <div class="form-group" style="padding-left:10px;padding-right:10px;" >

                            <label for="Name">Description:</label>
                            <textarea type="Name" name="description" class="form-control" id="Name" placeholder=" Description" rows="5" required></textarea>
